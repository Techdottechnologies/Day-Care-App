...
import 'package:adunestapp/page/home/parent/bottom_nav.dart';
...
class _ParentDrawerState extends State<ParentDrawer> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<MyDrawerControllerPA>(
      init: MyDrawerControllerPA(),
      builder: (MyDrawerControllerPA _) => GestureDetector(
        onTap: () {
          _.closeDrawer();
        },
        child: Stack(
...
class _DrawerScreenState extends State<DrawerScreen> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<MyDrawerControllerPA>(
        init: MyDrawerControllerPA(),
        builder: (MyDrawerControllerPA _) => Scaffold(
            backgroundColor: Colors.transparent,
            body: Stack(children: [
              Positioned.fill(
                  child: Align(
...
class MyDrawerControllerPA extends GetxController {
  @override
