...
import 'package:adunestapp/page/home/parent/parent_class_detail.dart';
                    ...
                    children: [
                      Row(
                        children: [
                          onPress(
                            ontap: (){
                              Get.find<MyDrawerControllerPA>().toggleDrawer();
                              Get.find<MyDrawerControllerPA>().update();
                          ...
                          Stack(
                            ...
                            children: [
                              Image.asset("assets/icons/bdp.png",height: 10.h),
                              Image.asset("assets/icons/bdp.png",height: 11.h,color: Colors.transparent,),

                              Positioned.fill(child: selectPopup())
                            ],
                          ),
                        ],
                      ),
