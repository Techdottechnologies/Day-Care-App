...
class _BottomNavTeacherState extends State<BottomNavTeacher> {
  @override
  Widget build(BuildContext context) {
    return GetBuilder<NavControllerTeacher>(
        init: NavControllerTeacher(),
        builder: (NavControllerTeacher _) => Scaffold(
...
class NavControllerTeacher extends GetxController {
  int selectedIndex = 0;
  bool isVisible = true;
